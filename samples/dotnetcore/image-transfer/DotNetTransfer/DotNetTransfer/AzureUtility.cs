...
namespace DotNetTransfer
{
    internal class AzureUtility
    {
        ...
        public KeyVaultManagementClient KeyVaultClient { get; private set; }
        ...
        public AzureUtility(AzureEnvironment environment, string tenantId, string subscriptionId, string miClientId, string spClientId, string spClientSecret)
        {
            ...
            KeyVaultClient = new KeyVaultManagementClient(credential.WithDefaultSubscription(subscriptionId));
